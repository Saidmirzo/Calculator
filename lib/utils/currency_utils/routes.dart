  ...
  static Route<dynamic> generateRoute(RouteSettings routeSettings) {
    try {
      ...
      switch (routeSettings.name) {
        ...
        case mainPage:
          return MaterialPageRoute(builder: (context) => const  CurrPage());
        case currencyPage:
          return MaterialPageRoute(builder: (context) =>  CurrencyPage(args?['list_currency'], args?['top_cur'], args?['bottom_cur']));
